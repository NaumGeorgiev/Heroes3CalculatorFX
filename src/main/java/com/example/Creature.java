        ...
        try {
            ...
            while (true) {
                ...
                creatures[i] = new Creature(stats[0], Integer.valueOf(stats[3]), Integer.valueOf(stats[4]),
                        ...
                        isMindSpellImmune(creatureInfo), isDoubleShooting(creatureInfo, isRanged),
                        getShotCount(creatureInfo, isRanged));
                i++;

            }
            creatures[i] = new Creature("Nymph", 5, 2, 1, 2, 4, false, false, new HashSet<>(), new HashSet<>(), false,
                    false, 0);
