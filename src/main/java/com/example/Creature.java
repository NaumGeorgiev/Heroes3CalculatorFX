...
public class Creature {
    ...
    public static Creature[] createAll() {
        ...
        try {
            ...
            creatures[i] = new Creature("Nymph", 5, 2, 1, 2, 4, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
			creatures[i + 1] = new Creature("Oceanid", 6, 2, 1, 3, 4, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
			creatures[i + 2] = new Creature("CrewMate", 7, 4, 2, 4, 15, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
			creatures[i + 3] = new Creature("Seaman", 8, 6, 3, 4, 15, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
			creatures[i + 4] = new Creature("Pirate", 8, 6, 3, 7, 15, true, false, new HashSet<>(), new HashSet<>(), false, false, 4);
			creatures[i + 5] = new Creature("Corasair", 10, 8, 3, 7, 15, true, false, new HashSet<>(), new HashSet<>(), false, false, 4);
			creatures[i + 6] = new Creature("SeaDog", 12, 11, 3, 7, 15, true, false, new HashSet<>(), new HashSet<>(), false, false, 12);
			creatures[i + 7] = new Creature("Stormbird", 10, 8, 6, 9, 30, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
			creatures[i + 8] = new Creature("Ayssid", 11, 8, 6, 10, 30, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
			creatures[i + 9] = new Creature("SeaWitch", 12, 7, 10, 14, 35, true, true, new HashSet<>(), new HashSet<>(), false, false, 0);
			creatures[i + 10] = new Creature("Sorceress", 12, 9, 10, 16, 35, true, true, new HashSet<>(), new HashSet<>(), false, false, 0);
			creatures[i + 11] = new Creature("Nix", 13, 16, 18, 22, 80, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
			creatures[i + 12] = new Creature("NixWarrior", 14, 17, 18, 22, 90, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
			creatures[i + 13] = new Creature("SeaSerpent", 22, 16, 30, 55, 180, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
			creatures[i + 14] = new Creature("Haspid", 29, 20, 30, 55, 300, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i + 15] = new Creature("Leprechaun", 8, 5, 3, 5, 15, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+16]=new Creature("Satyr", 10, 11, 6, 10, 35, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+17]=new Creature("SteelGolem", 10, 11, 6, 8, 45, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+18]=new Creature("Fangarm", 12, 12, 8, 12, 50, false, false, new HashSet<>(), new HashSet<>(), true, false, 0);
            creatures[i+19]=new Creature("HalflingGrenader", 5, 2, 2, 3, 4, true, true, new HashSet<>(), new HashSet<>(), false, false, 24);
            creatures[i+20]=new Creature("Mechanic", 6, 5, 2, 4, 14, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+21]=new Creature("Engineer", 7, 5, 2, 5, 16, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+22]=new Creature("Armadillo", 5, 10, 3, 5, 25, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+23]=new Creature("BellwetherArmadillo", 6, 11, 3, 5, 25, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+24]=new Creature("Automaton", 12, 10, 7, 7, 30, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+25]=new Creature("SentinelAutomaton", 12, 10, 9, 9, 30, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+26]=new Creature("Sandworm", 13, 12, 12, 16, 50, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+27]=new Creature("Olgoi-KhorKhoi", 15, 12, 12, 16, 60, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+28]=new Creature("Gunslinger", 17, 12, 14, 24, 45, true, true, new HashSet<>(), new HashSet<>(), false, false, 16);
            creatures[i+29]=new Creature("BountyHunter", 18, 14, 14, 24, 45, true, true, new HashSet<>(), new HashSet<>(), false, false, 24);
            creatures[i+30]=new Creature("Couatl", 17, 17, 25, 45, 160, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+31]=new Creature("CrimsonCouatl", 21, 21, 25, 45, 200, false, false, new HashSet<>(), new HashSet<>(), false, false, 0);
            creatures[i+32]=new Creature("Dreadnought", 18, 20, 40, 50, 200, false, false, new HashSet<>(), new HashSet<>(), true, false, 0);
            creatures[i+33]=new Creature("Juggernaut", 23, 23, 40, 50, 300, false, false, new HashSet<>(), new HashSet<>(), true, false, 0);
